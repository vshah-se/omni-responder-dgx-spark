...
### Standard Demo Clips:
1. `crash_scenario_1.mp4` — Multi-vehicle crash with commercial chemical tanker breach (Chlorine vapor plume).
2. `crash_scenario_2.mp4` — Highway rollover with fuel spill.
