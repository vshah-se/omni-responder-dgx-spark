...
class SystemSettings:
    ...
    spark_host: str = os.getenv("SPARK_HOST", "http://100.90.17.78:3000")
    nim_endpoint_url: str = os.getenv("NIM_ENDPOINT_URL", "http://100.90.17.78:3000/v1")
    vss_endpoint_url: str = os.getenv("VSS_ENDPOINT_URL", "http://100.90.17.78:3000")
